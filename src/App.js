          ...
          <Container>
            <Row className='shadow-sm banner'>
              ...
              <Col lg={8} className="p-10">
                ...
                <p className='ps-5' >Membros podem se  inscrever a eventos,  visitas e saber muito mais!</p>
                <p className='text-sm-center'>Fique sempre atento  as datas dos eventos, para não perder!</p>
                <p className='text-sm-end'>Que Deus  abençoe a todos!  Volte Sempre!</p>
              </Col>
            </Row>
          </Container>
          <div className='row'>
